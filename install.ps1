...
param (
    ...
    [string]$ArtifactDownloadUrl = 'https://github.com/mitsuhiko/insta/releases/download/1.46.1',
...
if ($env:CARGO_INSTA_DOWNLOAD_URL) {
  ...
  $ArtifactDownloadUrl = "$installer_base_url/mitsuhiko/insta/releases/download/1.46.1"
}
